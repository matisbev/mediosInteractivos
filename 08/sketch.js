...
var c=0
 ...
 function preload() {
   ...
   instu=loadImage('assets/instu.png');
   ...
   trof=loadImage('assets/trof.png');
 ...
 function draw() {
   if (backr==0){background(255);}
   noTint();
  var ales = random(0,5)
  var aleca = random(0,255)
   var alecb = random(0,255)
   var alecc = random(0,255)
...
var rand= random(0,3)
  ...
  if(frameCount>0){
     if (bolos.isPlaying() == false) {
       bolos.play();}}
   if(frameCount>10 && frameCount<160){
   image(titu,110,340,388,119)}
   
     if(frameCount>170 && frameCount<580){
   image(instu,97,118,414,542)}
   
   if(frameCount>590 && frameCount<1100){
   image(listo,97,215,414,368)
   fill(255,0,0)
     noStroke()
   rect(0,52,20,11)}
   
   if(frameCount>1970 && frameCount<6491){
     noFill()
    
     strokeWeight(4)
      stroke(ales)
    ellipse(517, 37, nivel * 2200)
     ellipse(517, 37, nivel * 5000)
     ellipse(517, 37, nivel * 700)
     
    ellipse(106, 126, nivel * 2200)
    ellipse(106, 126, nivel * 8000)
    ellipse(106, 126, nivel * 3200)
     
    ellipse(477, 201, nivel * 2200)
    ellipse(477, 201, nivel * 500)
    ellipse(477, 201, nivel * 4000) 
     
    ellipse(114, 268, nivel * 2200)
    ellipse(114, 268, nivel * 5567)
    ellipse(114, 268, nivel * 1000)
     
    ellipse(488, 303, nivel * 5000)
    ellipse(488, 303, nivel * 2200)
    ellipse(488, 303, nivel * 100)
     
    ellipse(479, 410, nivel * 2200)
    ellipse(479, 410, nivel * 4500)
    ellipse(479, 410, nivel * 7000)
     
    ellipse(170, 436, nivel * 2200)
    ellipse(170, 436, nivel * 1230)
    ellipse(170, 436, nivel * 5600)
     
    ellipse(152, 606, nivel * 9000)
    ellipse(152, 606, nivel * 1000)
    ellipse(152, 606, nivel * 2200)
     
    ellipse(513, 683, nivel * 8000)
   ellipse(513, 683, nivel * 7000)
   ellipse(513, 683, nivel * 4100)}

  if(frameCount>1100 && frameCount<6491){
 ...
 noStroke()
  ...
  rect(posxlin15, posylin15, tamxlin15, tamylin15)
   ...
   if(frameCount>2912 && frameCount<6491){
  
   noStroke()
       fill(255)
     ellipse(mouseX,mouseY,100)}

     if(frameCount>4400 && frameCount<6491){
      a=aleca
   b=alecb
   c=alecc}
 
   if(frameCount>6501 && frameCount<7000){
   image(horadd,97,167,414,465)}
   if(frameCount>7010&& frameCount<8200){
   backr=1
  ...
  //pincel tinta
  fill(1)
  ellipse(40,30,9*20*nivel)
  ellipse(45,35,13*20*nivel)
   ellipse(52,42,9*20*nivel)
  ellipse(60,50,6*20*nivel)
  //Linea Espaciada
  strokeWeight(2*20*nivel)
  line(85,50,100,25)
  strokeWeight(3*20*nivel)
  line(92,50,107,25)
  strokeWeight(1*20*nivel)
  line(100,50,115,25)
...
//Herramientas
  ...
  if (mouseIsPressed) {
    if (herrsel == 1) {
      ellipse(mouseX, mouseY, 300*nivel)
    }
  }
    //Linea Cambio stroke
  if (mouseIsPressed){
    if (herrsel == 2) {
      strokeWeight(alet)
      line(mouseX, mouseY, mouseX + 800*nivel, mouseY - 800*nivel)
    }
  }
  ...
  // bolos.pan(miPan);
   ...
   if(frameCount>8210&& frameCount<8500){
   backr=0
   image(grac,110,340,388,119)}
     if (frameCount>8700){ bolos.setVolume(0)}
   if(volsel==2){
     fill(0)
